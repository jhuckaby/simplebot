...
sub init {
	my $self = shift;
	$self->register_commands('calc', 'convert', 'rand', 'roll', 'dice', 'hash', 'md5', 'pick', 'b64encode', 'b64decode', 'urlencode', 'urldecode', '8ball', 'eightball');
}
